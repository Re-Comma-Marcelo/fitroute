...
export const dict: DictFragment = {
  pt: {
    ...
    // ── claude-bridge.ts
    "No ROUTE import code found. It should start with {prefix}":
    ...
    "That does not look like a ROUTE import code — copy the whole block Claude returned, including the part that starts with FORJA1.":
      "Isso não parece um código de importação ROUTE — copie o bloco inteiro que o Claude devolveu, incluindo a parte que começa com FORJA1.",
