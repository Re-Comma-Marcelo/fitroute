...
export const dict: DictFragment = {
  pt: {
    ...
    Volume: "Volume",
    Sets: "Séries",
    "{count}/{total} sets · target {min}-{max} reps":
      "{count}/{total} séries · meta {min}-{max} reps",
    ...
    "Session recorded. Here is the summary.": "Sessão registrada. Aqui está o resumo.",
    ...
    "First week recorded": "Primeira semana registrada",
  },
  nl: {
    ...
    Sets: "Sets",
    "{count}/{total} sets · target {min}-{max} reps":
      "{count}/{total} sets · doel {min}-{max} reps",
    ...
    "Session recorded. Here is the summary.": "Sessie geregistreerd. Hier is de samenvatting.",
    ...
    "First week recorded": "Eerste week geregistreerd",
  },
};
