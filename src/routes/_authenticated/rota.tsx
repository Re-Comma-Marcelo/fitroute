...
function RouteLayout() {
 ...
 <nav className="mb-4 grid grid-cols-2 gap-1 rounded-sm border border-border bg-card p-1">
...
function Tab({ to, label }: { to: "/rota" | "/rota/progresso"; label: string }) {
 ...
 className="tap-target rounded-sm py-2 text-center text-xs font-semibold text-muted-foreground transition-colors"
