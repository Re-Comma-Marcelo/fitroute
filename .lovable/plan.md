...
## 10. Consistência de `head()` por rota e SEO/compartilhamento
Revisar título/descrição de cada rota de conteúdo para textos próprios do Iron Logger, e conferir metadados de compartilhamento da tela pública de login.

## Detalhes técnicos
- Itens 1, 2, 4, 5, 7, 10 são puramente cliente/UI.
